      ...
      >
        ...
        <View style={[{ flex: 1, flexDirection: 'row', justifyContent: 'space-between' }]}>
          <View style={[{ flex: 1, flexDirection: 'row', alignItems: 'center' }]}>
            {item.schedule?
            <>
            <MaterialCommunityIcons name='timetable' color={GlobalStyles.brandGreen} size={18}/>
            <TextRegular textStyle={{color: GlobalStyles.brandGreen}}>
              {item.schedule.startTime}-{item.schedule.endTime}
            </TextRegular>
            </>:
            <>
            <MaterialCommunityIcons name='timetable' color={GlobalStyles.brandPrimary} size={18}/>
